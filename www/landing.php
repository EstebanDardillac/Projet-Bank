                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Changer mon mot de passe</h5>
                            ...
                            <div class="modal-body">
                                <form action="layouts/change_mdp.php" method="POST">
                                    <label for='current_password'>Mot de passe actuel</label>
                                    <input type="password" id="current_mdp" name="current_mdp" class="form-control" required/>
                                    <br />
                                    <label for='new_mdp'>Nouveau mot de passe</label>
                                    <input type="password" id="new_mdp" name="new_mdp" class="form-control" required/>
                                    <br />
                                    <label for='new_mdp_retype'>Re tapez le nouveau mot de passe</label>
                                    <input type="password" id="new_mdp_retype" name="new_password_retype" class="form-control" required/>
                                    <br />
